...
- **R24-RESP-06 (Estructura de Renglones en Formulario Paciente, Fichas y Separadores):**
  ...
  - **Dispositivos Móviles (≤767px):**
    ...
    - **Botones de Acción Cuadrados (Solo Iconos 1:1):** Selector específico `.tab-bar-btns .btn.badge-reset, .tab-bar-btns .btn.badge-reset-sm` anula paddings heredados y fija `width: 28px; height: 28px; padding: 0` para botones cuadrados 1:1 de lados exactamente iguales.
